...
public class FilmService {
    ...
    public FilmDto getFilmById(long id) {
        ...
        film.setGenres(new HashSet<>(genreDbStorage.getFilmGenres(id)));
    ...
    public FilmDto createFilm(Film film) {
        ...
        film.getGenres().forEach(genre -> genreDbStorage.addGenre(newFilm.getId(), genre.getId()));
        film.setGenres(new HashSet<>(genreDbStorage.getFilmGenres(newFilm.getId())));
        return FilmDtoMapper.mapToFilmDto(newFilm);
    }
    ...
    public Collection<FilmDto> getTopFilms(int filmsCount) {
